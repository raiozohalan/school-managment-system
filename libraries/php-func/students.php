	...
	while($row_pending = $query_pending->fetch()){ 
		...
		<tr id="rowPending<?=$row_pending["tbl_id"];?>">
			...
			<td class=" w3-border-right w3-center">
				...
				<button type="button" class="w3-btn w3-padding-small w3-theme-dark " onclick="loadModalContent('StudentModal','../libraries/php-func/add-grade-form.php?student_id=<?=$row_pending["tbl_id"];?>','StudentModal')"><i class="fa fa-plus"></i> Grade</button>
				<button type="button" class="w3-btn w3-padding-small w3-green " onclick="loadModalContent('StudentModal','../libraries/php-func/update-student-form.php?tbl_id=<?=$row_pending["tbl_id"];?>','StudentModal')"><i class="fa fa-edit"></i> Edit</button>
				<button type="button" class="w3-btn w3-padding-small w3-red " onclick="loadModalContent('StudentModal','../libraries/php-func/confirm-student-delete.php?tbl_id=<?=$row_pending["tbl_id"];?>','StudentModal')"><i class="fa fa-trash"></i> Delete</button>
			</td> 
		</tr>  
		<?php
	} 
