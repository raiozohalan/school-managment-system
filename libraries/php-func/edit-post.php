...
<div class="w3-col s12 m12 l12 w3-padding-small w3-theme-dark">
	<h3 class="w3-padding-0 w3-margin-0 w3-left">Edit Post</h3>
	<button type="button" onclick="$('#viewPost').fadeOut();" class="w3-btn w3-transparent w3-right w3-hover-theme"><i class="fa fa-close"></i> Close</button>
</div>
<form method="POST" action="../libraries/php-func/update-post.php" id="editPost" class="w3-col s12 m12 l12 w3-white">
	<div id="editPostResponseCon" class="w3-col s12 l12 m12"></div>
	<div class="w3-col s12 m6 l6 w3-white">
		...
		<div class="w3-col s12 m12 l12 w3-padding-medium">
			...
			<select name="type" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round w3-border w3-border-theme" required>
				<option <?php if($row["type"] == "News"){echo "selected";}?> >News</option>
				<option <?php if($row["type"] == "Event"){echo "selected";}?> >Event</option>
			</select>
		</div>
		<div class="w3-col s12 m12 l12 w3-padding-medium">
	...
	<div class="w3-col s12 m12 l12 w3-padding-medium w3-grey w3-margin-top">
		<button type="submit" name="submit" class="w3-btn w3-padding-large w3-round w3-green w3-right" onclick="send('editPost','../libraries/php-func/update-post.php','editPostResponseCon')" ><i class="fa fa-save"></i> Save</button>
	</div>
</form>