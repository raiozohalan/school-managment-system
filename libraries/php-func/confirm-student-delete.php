			...
			<div class="w3-modal-content w3-card-8 w3-animate-zoom w3-round w3-border w3-border-white w3-padding-0" style="max-width:600px;margin-top:20px;overflow:hidden;">
				...
				<div class="w3-padding-medium w3-white w3-col s12 m12 l12" id="msgContainer123">
					<?php
						...
						$row = $query->fetch();
					?>
					<p>Are you sure you want to delete <b class="w3-text-theme"><?=$row["fname"]." ".$row["mname"]." ".$row["lname"];?></b> to student list?</p>
					<button type="button" onclick="loadContent('msgContainer123','../libraries/php-func/delete-student.php?tbl_id=<?=$row["tbl_id"];?>&picture=<?=$row["picture"];?>')" class="w3-btn w3-padding-medium w3-green w3-section w3-round"  ><i class="fa fa-check"></i> Yes</button>
