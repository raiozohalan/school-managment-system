<?php
	...
	try{
		$query = "delete from tbl_news_and_events where tbl_id='".$_GET["tbl_id"]."'";
		$con->exec($query);
...
?>
<a href="view-post.php" class="w3-btn w3-padding-medium w3-grey w3-section w3-round"  ><i class="fa fa-close"></i> Close</a>