	...
	<form class="w3-white w3-col s12 m12 l12 w3-card-4 w3-margin-0" method="POST" action="../libraries/php-func/add-grade.php" id="add-grade">
		...
		<div class="w3-col s12 m6 l6 w3-white">
			<div class="w3-col s12 m12 l12 w3-padding-medium">
				...
				<select name="class_id" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round w3-border w3-border-theme" required onchange="if(this.value != ''){document.getElementById('subject_id').disabled =false;document.getElementById('quarter').disabled =false;loadContent('subject_id','../libraries/php-func/class-subjects.php?class_id='+this.value);}else{document.getElementById('subject_id').disabled =true;document.getElementById('quarter').disabled =true;}">
					<option value="" disabled selected>Select School Year</option>
					<?php 
						$querysy = $con->query("select * from tbl_class left join tbl_class_students on tbl_class.class_id = tbl_class_students.class_id order by tbl_class.sy ASC");
