	...
	<div class="w3-col s12 m12 l12 w3-theme w3-padding-0" style="height:100%;">
			...
			<div class="w3-padding-top" style="height:auto;max-height:68%;min-height:auto;overflow-x:hidden;overflow-y:auto;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom w3-border-top w3-border-white" id="classDrp" style="display:block;">
						...
						<a href="view-class.php" class="w3-padding-medium w3-left-align w3-col s12 m12 l12 w3-btn w3-hover-white  w3-white w3-text-black"><i class=" fa fa-chevron-right "></i> View Class List</a> 
					</div>
				</div>
				<div class="w3-col s12 m12 l12">
		...
		<div class="w3-col s12 m9 l9 w3-padding-0 w3-right w3-margin-0 " >
			...
			<div class="w3-padding-large w3-col s12 m12 l12 w3-margin-top">
				<div class="w3-padding-medium w3-col s12 m12 l12 w3-white"><a  class="w3-padding-small w3-white ">Class</a>/<a href="view-class.php" class="w3-padding-small w3-white hover-underline">View Class List</a>
				</div>
			</div>
			...
			<div class="w3-padding-large w3-col s12 m12 l12" id="classListContainer">  
				<div class="w3-col s8 m3 l3 w3-right w3-margin-bottom" >
					<select class="w3-input w3-padding-medium" id="schoolYear" onchange="loadContent('classList','../libraries/php-func/view-class.php?sy='+this.value);">
				...
				<table class="w3-table w3-bordered w3-border w3-border-grey">
					...
					<tbody id="classList">
						<?php
							include("../libraries/php-func/view-class.php");
						?>
					</tbody>
				</table>
			</div>  
			<div class="w3-padding-large w3-col s12 m12 l12" id="classDetails">  
