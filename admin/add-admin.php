	...
	<div class="w3-col s12 m12 l12 w3-theme w3-padding-0" style="height:100%;">
		<div class="w3-col s10 m3 l3 w3-border-right w3-border-light-grey w3-card-8 w3-theme-dark w3-animate-left" style="height:100%;position:fixed;z-index:998;" id="navigationBar">
			...
			<div class="w3-padding-top" style="height:auto;max-height:68%;min-height:auto;overflow-x:hidden;overflow-y:auto;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom  w3-border-white" id="AdminsDrp" style="display:block;">
						<a href="add-admin.php" class="w3-padding-medium w3-left-align w3-col s12 m12 l12 w3-btn w3-hover-white w3-white w3-text-black"><i class=" fa fa-chevron-right "></i> Registration</a>
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom  w3-border-white" id="studentDrp" style="display:none;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom  w3-border-white" id="facultyDrp" style="display:none;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom  w3-border-white" id="newseventsDrp" style="display:none;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom  w3-border-white" id="siteMaintenanceDrp" style="display:none;">
		...
		<div class="w3-col s12 m9 l9 w3-padding-0 w3-right w3-margin-0 " >
			...
			<div class="w3-padding-large w3-col s12 m12 l12 w3-margin-top">
				<div class="w3-padding-medium w3-col s12 m12 l12 w3-white"><a href="dashboard.php" class="w3-padding-small w3-white hover-underline">Dashboard</a>/<a href="admins.php" class="w3-padding-small w3-white hover-underline">Admins</a>/<a href="add-admin.php" class="w3-padding-small w3-white hover-underline">Registration</a>
				</div>
			</div>
			<div class="w3-col s12 m2 l2 w3-container" id="addAdminResponse"></div>
			<form action="../libraries/php-func/add-admin.php" method="POST" class="w3-padding-medium w3-col s12 m8 l8" id="addAdminForm">
				<div class="w3-col s12 m12 l12 w3-padding-small  w3-center">
					<img src="../images/default.png" class="" height="200px" width="auto" id="changeImageSrc">
					<div class="w3-clear"></div>
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<input type="file" name="picture" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  " onchange="readURL(this,'changeImageSrc','image')" required>
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>First Name</label> 
					<input type="text" name="fname" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  " required >
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>Middle Name</label>
					<input type="text" name="mname" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  " required>
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>Last Name</label>
					<input type="text" name="lname" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  " required >
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>Postion</label>
					<input type="text" name="position" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  " required >
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>Username</label>
					<input type="username" name="username" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  " required >
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>Password</label>
					<input type="password" name="password" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  "required >
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<label>Repeat Password</label>
					<input type="password" name="repeat_password" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  "required >
				</div>
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<button onclick="send('addAdminForm','../libraries/php-func/add-admin.php','addAdminResponse');" class="w3-padding-medium w3-btn w3-hover-white w3-green w3-round" type="submit"><i class=" fa fa-save w3-xlarge"></i> Save </button>
				</div>
			</form> 
