	...
	<div class="w3-col s12 m12 l12 w3-theme w3-padding-0" style="height:100%;">
		<div class="w3-col s10 m3 l3 w3-border-right w3-border-light-grey w3-card-8 w3-theme-dark w3-animate-left" style="height:100%;position:fixed;z-index:998;" id="navigationBar">
			...
			<div class="w3-padding-top" style="height:auto;max-height:68%;min-height:auto;overflow-x:hidden;overflow-y:auto;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom w3-border-top w3-border-white" id="studentDrp" style="display:block;">
						<a href="add-student.php" class="w3-padding-medium w3-left-align w3-col s12 m12 l12 w3-btn w3-hover-white w3-white w3-text-black"><i class=" fa fa-chevron-right "></i> Registration</a>
		...
		<div class="w3-col s12 m9 l9 w3-padding-0 w3-right w3-margin-0 " >
			...
			<div class="w3-padding-large w3-col s12 m12 l12 w3-margin-top">
				<div class="w3-padding-medium w3-col s12 m12 l12 w3-white"><a href="dashboard.php" class="w3-padding-small w3-white hover-underline">Dashboard</a>/ <a  href="students.php" class="w3-padding-small w3-white hover-underline">Students</a>/ <a href="add-students.php" class="w3-padding-small w3-white hover-underline">Registration</a>
				</div>
			</div>
			
			<div class="w3-padding-large w3-col s12 m12 l12">
				<form method="POST" action="../libraries/php-func/add-student.php" enctype="multipart/form-data" class="w3-padding-small w3-white w3-col s12 m12 l12" id="registrationForm">
				...
				<div class="w3-col s12 m6 l6 w3-white">
					...
					<div class="w3-col s12 m12 l12 w3-padding-medium w3-hide">
						...
						<input type="text" name="id_number" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round w3-border w3-border-theme" placeholder="Enter ID number">
					</div>
					...
					<div class="w3-col s12 m12 l12 w3-padding-medium">
						...
						<input type="text" name="religion" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round w3-border w3-border-theme" placeholder="Enter religion" required>
					</div>
					<div class="w3-col s12 m12 l12 w3-padding-medium w3-margin-bottom">
						<label><b>Mother Tongue </b></label>
						<textarea name="mtongue" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round w3-border w3-border-theme" placeholder="Enter mother tongue " style="width:100%;max-width:100%;min-width:100%;height:100px;overflow-x:hidden;overflow-y:auton;" required></textarea>
					</div> 
				</div>
				...
				<div class="w3-col s12 m6 l6 w3-light-grey">
					...
					<div class="w3-col s12 m12 l12 w3-padding-medium">
						...
						<input type="text" name="guardian_name" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  w3-border w3-border-theme" placeholder="Enter Guardian full name" required>
					</div>
					<div class="w3-col s12 m12 l12 w3-padding-medium">
						<label><b>Contact Number</b></label>
						<input type="text" name="guardian_contact" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  w3-border w3-border-theme" placeholder="Enter Guardian contact number" required>
					</div>
					<div class="w3-col s12 m12 l12 w3-padding-medium">
						<label><b>Relationship of Guardian</b></label>
						<input type="text" name="guardian_rel" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  w3-border w3-border-theme w3-margin-bottom" placeholder="Enter relationship of guardian" required>
					</div>
				</div>
				<div class="w3-col s12 m6 l6 w3-light-grey">
				...
				<div class="w3-col s12 m12 l12 w3-light-grey">
					...
					<div class="w3-col s12 m6 l6 w3-padding-medium">
						...
						<input type="text" name="mother" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  w3-border w3-border-theme" placeholder="Enter mother full name" required>
					</div>
					<div class="w3-col s12 m6 l6 w3-padding-medium w3-margin-bottom">
						<label><b>Father</b></label>
						<input type="text" name="father" class="w3-col s12 m12 l12 w3-padding-medium w3-border-white w3-border w3-round  w3-border w3-border-theme" placeholder="Enter Father full name" required>
					</div>
				</div>
				
				<div class="w3-col s12 m12 l12 w3-theme w3-padding-large w3-right-align">
					<button type="submit" name="submit" class="w3-btn w3-padding-large w3-round w3-green" onclick="send('registrationForm','../libraries/php-func/add-student.php','registrationResponseCon')"><i class="fa fa-check"></i> Register</button>
				</div>
