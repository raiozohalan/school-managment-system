	...
	<div class="w3-col s12 m12 l12 w3-theme w3-padding-0" style="height:100%;">
			...
			<div class="w3-padding-top" style="height:auto;max-height:68%;min-height:auto;overflow-x:hidden;overflow-y:auto;">
				...
				<div class="w3-col s12 m12 l12">
					...
					<div class="w3-col s12 m12 l12 w3-padding-left w3-padding-0 w3-animate-left w3-theme-light w3-border-bottom w3-border-top w3-border-white" id="facultyDrp" style="display:block;">
						...
						<a href="faculty.php" class="w3-padding-medium w3-left-align w3-col s12 m12 l12 w3-btn w3-hover-white w3-white w3-text-black"><i class=" fa fa-chevron-right "></i> View Faculty</a>
					</div>
				</div>
		...
		<div class="w3-col s12 m9 l9 w3-padding-0 w3-right w3-margin-0 " >
			...
			<div class="w3-padding-large w3-col s12 m12 l12 w3-margin-top">
				<div class="w3-padding-medium w3-col s12 m12 l12 w3-white"><a href="dashboard.php" class="w3-padding-small w3-white hover-underline">Dashboard</a>/ <a  class="w3-padding-small w3-white">Faculty</a>/ <a href="faculty.php" class="w3-padding-small w3-white hover-underline">View Faculty</a>
				</div>
			</div>
			<div id="FacultyModal" class="w3-modal w3-animate-zoom w3-padding-0" style="background:rgba(0,0,0,0.90);display:none;z-index:999;"> 
			</div>
			...
			<div class="w3-padding-medium w3-col s12 m12 l12 w3-theme">
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<div class="w3-col s12 m12 l12">
						<h3 class="w3-col s12 m3 l3 w3-margin-0">Faculty List</h3>
						<form class="w3-col s12 m9 l9" action="../libraries/php-func/faculty.php" method="POST" id="studentSearch">
							<button type="submit" name="submit"  class="w3-btn w3-padding-small w3-green w3-border w3-border-theme-dark w3-right " onclick="send('studentSearch','../libraries/php-func/faculty.php','facultyList')"><i class="fa fa-search"></i> Search</button>
						...
						<table class="w3-table w3-bordered w3-border w3-white w3-display-container">
							<thead>
								<tr class="w3-theme-dark">
									...
									<th class=" w3-border-right">Address</th> 
			...
			<script>
				document.body.onload = loadContent('facultyList','../libraries/php-func/faculty.php'); 
			</script> 
			<?php
				footer("");
			?>
