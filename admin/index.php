...
?>
	<div class="w3-col s12 m12 l12 w3-container w3-theme w3-padding-64" style="height:100%;">
		...
		<div class="w3-col s12 m4 l4 w3-container w3-padding-0">
			<h3 class="w3-center w3-border-bottom w3-border-theme-dark w3-padding-bottom "><b>Admin Login</b></h3>
			<div id="loginResponseCon"></div>
			<form class="w3-container w3-padding-small w3-margin-top" action="../libraries/php-func/verify-admin-login.php" method="POST" id="loginForm"> 
				...
				<button class="w3-btn w3-padding-large w3-green w3-section w3-round" type="submit" name="submit" onclick="send('loginForm','../libraries/php-func/verify-admin-login.php','loginResponseCon')"><i class="fa fa-sign-in"></i> Login</button> 
			</form>
