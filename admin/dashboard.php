	...
	<div class="w3-col s12 m12 l12 w3-theme w3-padding-0" style="height:100%;">
		<div class="w3-col s10 m3 l3 w3-border-right w3-border-light-grey w3-card-8 w3-theme-dark w3-animate-left" style="height:100%;position:fixed;z-index:998;" id="navigationBar">
			...
			<div class="w3-padding-top" style="height:auto;max-height:68%;min-height:auto;overflow-x:hidden;overflow-y:auto;">
				...
				<a href="dashboard.php" class="w3-padding-medium w3-left-align w3-col s12 m12 l12 w3-btn w3-hover-white w3-white"><i class=" fa fa-dashboard w3-xlarge"></i> Dashboard</a>
		...
		<div class="w3-col s12 m9 l9 w3-padding-0 w3-right w3-margin-0 " >
			...
			<div class="w3-padding-large w3-col s12 m12 l12 w3-margin-top">
				<div class="w3-padding-medium w3-col s12 m12 l12 w3-white"><a href="dashboard.php" class="w3-padding-small w3-white hover-underline">Dashboard</a>/ 
				</div>
			</div>
			...
			<div class="w3-padding-medium w3-col s12 m12 l12 w3-theme" style="overflow-x:auto;">
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<div class="w3-col s12 m12 l12">
						<h3 class="w3-col s12 m3 l3 w3-margin-0">Pending Students</h3>
						<form class="w3-col s12 m9 l9" action="../libraries/php-func/pending-students.php" method="POST" id="PendingStudListSearch">
							<button type="submit" name="submit"  class="w3-btn w3-padding-small w3-green w3-border w3-border-theme-dark w3-right " onclick="send('PendingStudListSearch','../libraries/php-func/pending-students.php','PendingStudList')"><i class="fa fa-search"></i> Search</button>
			...
			<div class="w3-padding-medium w3-col s12 m12 l12 w3-theme" style="overflow-x:auto;">
				<div class="w3-col s12 m12 l12 w3-padding-small">
					<div class="w3-col s12 m12 l12">
						<h3 class="w3-col s12 m3 l3 w3-margin-0">Confirmed Students</h3>
						<form class="w3-col s12 m9 l9" action="../libraries/php-func/confirmed-students.php" method="POST" id="ConfirmedStudListSearch">
							<button type="submit" name="submit"  class="w3-btn w3-padding-small w3-green w3-border w3-border-theme-dark w3-right " onclick="send('ConfirmedStudListSearch','../libraries/php-func/confirmed-students.php','ConfirmedStudList')"><i class="fa fa-search"></i> Search</button>
							<select name="limit"  class="w3-btn w3-medium w3-white w3-border w3-border-theme-dark w3-right ">
								<option>25</option>
								<option>50</option>
								<option>100</option>
			...
			<script>
				document.body.onload = loadContent('PendingStudList','../libraries/php-func/pending-students.php');
				document.body.onload = loadContent('ConfirmedStudList','../libraries/php-func/confirmed-students.php');
			</script>
			<?php
				footer("");
			?>
